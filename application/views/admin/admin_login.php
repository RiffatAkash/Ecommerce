            ...
            <div class="row-fluid">
                ...
                <div class="row-fluid">
                    <div class="login-box">
                        ...
                        <form class="form-horizontal" action="<?php echo base_url() ?>admin_login/check_admin_login" method="post">
                            <fieldset>

                                <div class="input-prepend" title="Email">
                                    <span class="add-on"><i class="halflings-icon user"></i></span>
                                    <input class="input-large span10" name="email" required="" id="email" type="email" placeholder="type email"/>
                                </div>
