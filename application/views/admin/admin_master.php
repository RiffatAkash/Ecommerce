			...
			<div id="sidebar-left" class="span2">
				<div class="nav-collapse sidebar-nav">
					<ul class="nav nav-tabs nav-stacked main-menu">
						...
						<li><a href="<?php echo base_url()?>admin/add_category"><i class="icon-envelope"></i><span class="hidden-tablet"> Add Category</span></a></li>
						<li><a href="<?php echo base_url()?>admin/manage_category"><i class="icon-envelope"></i><span class="hidden-tablet"> Manage Category</span></a></li>
						<li><a href="<?php echo base_url()?>admin/add_manufacture"><i class="icon-envelope"></i><span class="hidden-tablet"> Add Manufacture</span></a></li>
						<li><a href="<?php echo base_url()?>admin/manufacture_manufacture"><i class="icon-envelope"></i><span class="hidden-tablet"> manage Manufacture</span></a></li>
				                <li><a href="<?php echo base_url()?>admin/add_product"><i class="icon-envelope"></i><span class="hidden-tablet"> Add Product</span></a></li>
					        <li><a href="<?php echo base_url()?>admin/manage_product"><i class="icon-envelope"></i><span class="hidden-tablet"> Manage Product</span></a></li>
					        <li><a href="<?php echo base_url()?>invoice/manage_invoice"><i class="icon-envelope"></i><span class="hidden-tablet"> Invoice</span></a></li>
