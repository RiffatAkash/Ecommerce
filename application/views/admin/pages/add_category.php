			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
                                            <form class="form-horizontal" action="<?php echo base_url()?>admin/save_category" method="post">
						  <fieldset>
							...
							<div class="control-group hidden-phone">
							  <label class="control-label" for="textarea2">Add Category Description</label>
							  <div class="controls">
