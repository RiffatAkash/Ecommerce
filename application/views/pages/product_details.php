    ...
    <div class="product-details"><!--product-details-->
        <div class="col-sm-5">
            <div class="view-product">
                <img src="<?php echo base_url().$product_details_by_id->product_image?>" alt="" />
                <h3>ZOOM</h3>
            </div>
...
<!--                    <div class="item active">
        ...
        <div class="col-sm-7">
            <div class="product-information"><!--/product-information-->
                ...
                <h2><?php echo $product_details_by_id->product_name?></h2>
                <span>
                    <form action="<?php echo base_url()?>cart/add_to_cart" method="post">
                    <span>Tk <?php echo $product_details_by_id->product_new_price?></span>
                    <label>Quantity:</label>
                    <input type="text" value="1" name="product_quantity" />
                    <input type="hidden" value="<?php echo $product_details_by_id->product_id?>" name="product_id" />
                ...
                <p><b>Brand:</b> <?php echo $product_details_by_id->manufacture_name?></p>
            ...
            <div class="tab-pane fade active in" id="reviews" >
                <div class="col-sm-12">
                    ...
                    <form action="#">
                        ...
                        <b>Rating: </b> <img src="<?php echo base_url()?>asset/images/product-details/rating.png" alt="" />
